...
function fetchRoster () {
    fetch(api_endpoint + "teams/SAGH/roster/current", { headers: headers })
    ...
    fetch(api_endpoint + "teams/SAGH/roster/current/managers", { headers: headers })
        .then(response => response.json())
        .then(json => {
...
function handleSubmit (form) {
    ...
    fetch(api_endpoint + "attendance/submit", { method: "POST", headers: headers, body: JSON.stringify(obj)})
        .then(response => {
...
async function updateAttendance () {
    if (document.readyState === "complete") {
        ...
        let resp = await fetch(api_endpoint + "attendance/date/" + date + "/" + type, {
            method: "GET",
            headers: headers
        })
